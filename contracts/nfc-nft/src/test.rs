...
//!    This prints message hashes for all nonces used in tests.
//!
...
//! ## Important Notes
//!
//! - Message hash = SHA256(message_bytes + nonce.to_xdr())
...
const TEST_SIGNATURES: &[TestSignature] = &[
    ...
    TestSignature {
        ...
        message: TEST_MESSAGE,
        sig_r: [
            0xa7, 0xfd, 0xf9, 0x33, 0x12, 0x3d, 0x28, 0x9c, 0xcf, 0xae, 0x00, 0xf2, 0x07, 0xb6, 0xd2, 0x65,
            0x33, 0x29, 0x2d, 0x7e, 0x7e, 0x95, 0xde, 0x69, 0xcb, 0x4b, 0x7d, 0x1c, 0xf4, 0xaa, 0x2d, 0xd6,
        ],
        sig_s: [
            0x79, 0xc1, 0x94, 0xa8, 0x6b, 0xb9, 0xed, 0x6c, 0xa3, 0x56, 0x41, 0xbb, 0x8d, 0xf6, 0x1b, 0x6e,
            0xdd, 0x0e, 0x9c, 0x2c, 0x50, 0x99, 0x75, 0x15, 0x58, 0xf3, 0xe1, 0xa1, 0x00, 0x7c, 0x91, 0x18,
        ],
        public_key: CHIP2_PUBLIC_KEY,
    },
];
